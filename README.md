...
I'm a third-year Computer Science (Data Science) student passionate about building **end-to-end AI/ML systems** and **scalable full-stack applications** that solve real-world problems — not just prototypes.

- 🏆 **Runner-Up** – AI/ML Track | HackNova National Hackathon 2026 (400+ participants)
- 🔭 Currently exploring advanced ML, system design, and cloud-based data engineering
- 🤝 Open to collaborating on AI/ML, full-stack, and blockchain projects
- 🎓 Sem 3 CGPA: **10.0** | A.P. Shah Institute of Technology
...
### 🎯 [Quizventure – Technical Quiz Platform](https://github.com/yashbhosale8105)
> JavaScript · React.js · Node.js

Interactive quiz platform with dynamic scoring, leaderboards, and a component-driven React UI.
...
| Eduskills | Python Full Stack Developer Virtual Internship |
| Eduskills | Data Science Master & Data Engineering Virtual Internship |
| Simplilearn | Data Scientist: Statistics for Data Science |
